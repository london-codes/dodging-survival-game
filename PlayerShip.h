...
public:
    ...
    void rotateRight(float dt) { visual.rotate(-rotationRate * dt); hitBox.rotate(-rotationRate * dt); exhaustVisual.rotate(-rotationRate * dt); }
    void rotateLeft(float dt) { visual.rotate(rotationRate * dt); hitBox.rotate(rotationRate * dt); exhaustVisual.rotate(rotationRate * dt); }
